...
# script
#If NEI2016, NEI2019 or NEI2022 are FALSE, it defaults to NEI2016.
NEI2016="FALSE"
NEI2019="FALSE"
...
if [ "${NEI2016}" = "TRUE" ]; then  #Use NEI2016
  ...
  if [ "${USE_GFS_SFC}" = "TRUE" ]; then
    cp ${PARMdir}/nexus_config/cmaq_gfs_megan_nei2022/*.rc ${DATA}
  else
    cp ${PARMdir}/nexus_config/cmaq_nei2022/*.rc ${DATA}
  fi
