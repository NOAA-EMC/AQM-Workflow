...
COMROOT=/gpfs/f6/drsa-fire2/world-shared/AQM-Data/com
OPSROOT=$(realpath ${COMROOT}/..)
COMaqm=${COMROOT}/aqm/${aqm_ver}
COMINgefs=${COMROOT}/gefs/${gefs_ver}
COMINgfs=${COMROOT}/gfs/${gfs_ver}
...
for file_in in ${File_to_modify_source}; do
  cp "$HOMEaqm/parm/config/${file_in}_${MACHINE_ID}.template" .
  file_src="${file_in}_${MACHINE_ID}.template"
  ...
  sed -i -e "s|@COMINgfs@|${COMINgfs}|g"           "$file_tmp"
