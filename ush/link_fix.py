...
def link_fix(
    ...
    **kwargs,
    ...
    if file_group == "grid":
        ...
        if ccpp_phys_suite == "FV3_HRRR" or ccpp_phys_suite == "FV3_GFS_v15_thompson_mynn_lam3km" or ccpp_phys_suite == "FV3_GFS_v17_p8" or ccpp_phys_suite == "FV3_GFS_v17_p8_ugwpv1":
            fns += [
