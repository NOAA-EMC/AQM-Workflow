...
ecflow_client --load /ecf/defs/output.def # This should he soft_coded to use variable 'aqm_${workflow_mode}.def'

#ecflow_client --begin /aqm_test #This should be soft coded to use a variable 'suite_name'
ecflow_client --begin /test_aqm #This should be soft coded to use a variable 'suite_name'
