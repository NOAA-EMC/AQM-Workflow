...
COMaqm=${PTMP}/${USER}/ecflow_aqm/para/com/aqm/${aqm_ver}
COMINgefs=/gpfs/f6/drsa-fire2/world-shared/AQM-Data/com/gefs/${gefs_ver}
COMINgfs=/gpfs/f6/drsa-fire2/world-shared/AQM-Data/com/gfs/v16.3
