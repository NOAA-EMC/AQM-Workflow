...
WARMSTART_PDY="20230701"

# [directories]
OPSROOT=/lfs/h2/emc/nems/noscrub/brian.curtis/aqm_dirs
COMROOT=/lfs/h2/emc/nems/noscrub/brian.curtis/aqm_dirs/com/aqm/v8.0
...
# [metadata]
description='config for Online-CMAQ, AQM_NA_13km, real-time, DEV mode on WCOSS2'
version='1.0'
